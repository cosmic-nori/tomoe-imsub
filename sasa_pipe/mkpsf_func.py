...
def make_psfmodel(input_file, save_dir, star_num=25, psfrad=5, fitrad=4):
    ...
    #20230712
    ellip_psf = 1 - df_psfstars['b']/df_psfstars['a']
    ##########
    ...
    try:
        ...
        seeingFWHM = np.sqrt(FWHM_X**2+FWHM_Y**2) /np.sqrt(2)
        print('seeing FWHM : {} arcsec'.format(seeingFWHM*1.19))
        # return psf_data, psf_header, seeingFWHM,df_psfstars,data_segmap
        return psf_data, psf_header, seeingFWHM,df_psfstars,data_segmap,ellip_psf   #ellip_psf is added on 0223/07/11
